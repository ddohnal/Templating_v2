...
const rgb = "#e3b04b";
const rgbBright = "#F6DCA7";
const rgbHead = ["#FFFAF0", "#F0E3D2", "#C0A981", "#BCA533"];
const rgbTail = ["#000500", "#302300", "#502D00", "#704F00"];
